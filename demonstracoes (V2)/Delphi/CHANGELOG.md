...
* DC-1998 - Compatibilização do fluxo de Barueri - SP com o Componente NFSe V2.
...
* DC-1817 - Correção na configuração do e-mail na V2 para que não seja necessário fazer o LoadConfig.
* DC-1882 - Correção na impressão do País tomador da NFS-e para Niterói/RJ.
* DC-1928 - Correção na impressão do padrão EddyData.
* DC-1870 - Correção da interpretação do retorno do envio do padrão Tiplan, quando contém tag ListaMensagemRetorno (com mensagens de avisos), mas foi bem-sucedido (agora interpreta como sucesso e não mais como falha).
...
* DC-1320 - Disponibilizado método ObterPDF para o padrão COTIA;
...
* DC-1444 - Alteração para configurar o diretório ApplicationLog Utilizando a propriedade DiretorioLogErro.
